...
export const MODEL_CATALOG: ModelCatalogEntry[] = [
  ...
  },
  {
    ...
    ram: '~8 GB',
    speed: '⚡⚡⚡',
    description: 'Coder de BigCode. Buen autocompletado en Python, JS, Java y más.',
    bestFor: ['programar', 'autocompletado'],
    tasks: { completion: true, chat: true, agent: true },
    minTier: 'normal',
    pullCmd: 'ollama pull starcoder2:7b',
  },
  {
    name: 'codellama:7b',
    size: '3.8 GB',
    ram: '~8 GB',
    speed: '⚡⚡⚡',
    description: 'Meta Code Llama. Alternativa sólida si Qwen no está disponible.',
    bestFor: ['programar', 'autocompletado'],
    tasks: { completion: true, chat: true, agent: true },
    minTier: 'normal',
    pullCmd: 'ollama pull codellama:7b',
  },
  {
    name: 'mistral:7b',
    size: '4.1 GB',
    ram: '~8 GB',
    speed: '⚡⚡⚡',
    description: 'Razonamiento y chat general. Complementa modelos coder.',
    bestFor: ['chat', 'general', 'enseñar'],
    tasks: { chat: true },
    minTier: 'normal',
  ...
  },
  {
    ...
    ram: '~10 GB',
    speed: '⚡⚡⚡',
    description: 'Google Gemma 2. Buen equilibrio chat/código en PCs con 16+ GB RAM.',
    bestFor: ['chat', 'programar', 'general'],
    tasks: { chat: true, agent: false },
    minTier: 'good',
    pullCmd: 'ollama pull gemma2:9b',
  },
  {
    ...
    ram: '~5 GB',
    speed: '⚡⚡⚡⚡',
    description: 'Coder compacto. Ideal autocompletado en portátiles con 8–12 GB RAM.',
    bestFor: ['autocompletado', 'chat'],
    tasks: { completion: true, chat: true },
    minTier: 'normal',
    pullCmd: 'ollama pull qwen2.5-coder:3b',
  },
];
